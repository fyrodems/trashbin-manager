...
export interface OfficialCardsAddMutationProps {
...
export interface OfficialCardsAddMutation {
  __typename?: 'Mutation'
  official?: {
  ...
  definitions: [
    {
      ...
      operation: 'mutation',
      name: { kind: 'Name', value: 'OfficialCardsAdd' },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'OfficialCardsAddMutationProps' },
            },
          },
        },
      ],
