...
export interface OfficialDumpstersDeleteMutationProps {
  card_ID: Scalars['Int']
...
export interface OfficialDumpstersDeleteMutation {
  __typename?: 'Mutation'
  official?: {
...
export const OfficialDumpstersDeleteDocument = {
  ...
  definitions: [
    {
      ...
      operation: 'mutation',
      name: { kind: 'Name', value: 'OfficialDumpstersDelete' },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              ...
              name: {
                kind: 'Name',
                value: 'OfficialDumpstersDeleteMutationProps',
              },
            },
          },
        },
  ...
  OfficialDumpstersDeleteMutation,
