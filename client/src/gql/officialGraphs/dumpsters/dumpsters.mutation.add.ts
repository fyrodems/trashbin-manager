...
export interface OfficialDumpstersAddMutationProps {
  card_ID: Scalars['Int']
...
export interface OfficialDumpstersAddMutation {
  __typename?: 'Mutation'
  official?: {
...
export const OfficialDumpstersAddDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'OfficialDumpstersAdd' },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              ...
              name: {
                kind: 'Name',
                value: 'OfficialDumpstersAddMutationProps',
              },
            },
          },
        },
  ...
  OfficialDumpstersAddMutation,
  OfficialDumpstersAddMutationVariables
>
