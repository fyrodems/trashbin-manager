...
export interface OfficialContractsDeleteMutationProps {
  dumpsterContract_ID: Scalars['Int']
}

export type OfficialContractsDeleteMutationVariables = Exact<{
  props: OfficialContractsDeleteMutationProps
}>

export interface OfficialContractsDeleteMutation {
  __typename?: 'Mutation'
  official?: {
...
export const OfficialContractsDeleteDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'OfficialContractsDelete' },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              ...
              name: {
                kind: 'Name',
                value: 'OfficialContractsDeleteMutationProps',
              },
            },
          },
        },
  ...
  OfficialContractsDeleteMutation,
  OfficialContractsDeleteMutationVariables
>
