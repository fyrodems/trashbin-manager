...
export interface OfficialContractsEditMutationProps {
...
export interface OfficialContractsEditMutation {
  __typename?: 'Mutation'
  official?: {
...
export const OfficialContractsEditDocument = {
  ...
  definitions: [
    {
      ...
      operation: 'mutation',
      name: { kind: 'Name', value: 'OfficialContractsEdit' },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              ...
              name: {
                kind: 'Name',
                value: 'OfficialContractsEditMutationProps',
              },
            },
          },
        },
  ...
  OfficialContractsEditMutation,
  OfficialContractsEditMutationVariables
>
