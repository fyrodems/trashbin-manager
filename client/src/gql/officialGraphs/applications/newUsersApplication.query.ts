...
import { type UserInfoType } from '@/gql/commonTypes'

export interface OfficialApplicationsNewUsersQueryProps {
  users_data?: string
}

export type OfficialApplicationsNewUsersQueryVariables = Exact<{
  props: OfficialApplicationsNewUsersQueryProps
}>

export interface OfficialApplicationsNewUsersQuery {
  __typename?: 'Query'
  official?: {
...
export const OfficialNewUsersApplicationGetDocument = {
  ...
  definitions: [
    {
      ...
      operation: 'query',
      name: { kind: 'Name', value: 'OfficialNewUsersApplicationGet' },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              ...
              name: {
                kind: 'Name',
                value: 'OfficialApplicationsNewUsersQueryProps',
              },
            },
          },
        },
  ...
  OfficialApplicationsNewUsersQuery,
  OfficialApplicationsNewUsersQueryVariables
>
