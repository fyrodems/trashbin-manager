...
export interface SuperOfficialNewOfficialAddMutationProps {
...
export type SuperOfficialNewOfficialAddMutationVariables = Exact<{
  props: SuperOfficialNewOfficialAddMutationProps
}>

export interface SuperOfficialOfficialAddMutation {
  __typename?: 'Mutation'
  official?: {
...
export const SuperOfficialOfficialAddDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'SuperOfficialOfficialAdd' },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              ...
              name: {
                kind: 'Name',
                value: 'SuperOfficialNewOfficialAddMutationProps',
              },
            },
          },
        },
  ...
  SuperOfficialOfficialAddMutation,
  SuperOfficialNewOfficialAddMutationVariables
>
