...
import { type InputMaybe, type Scalars, type Maybe } from '../graphql'
import {
  type OfficialSelectedUserBasicInfoDataType,
  type OfficialSelectedUserAddressInfoType,
  type OfficialSelectedUserDumpstersType,
  type OfficialSelectedUserCardsType,
  type UserContractsType,
} from '../commonTypes'

export interface OfficialSelectedUserDataGetQueryProps {
  props: {
...
export interface OfficialSelectedUserDataType {
  ...
  userType: number
  basicInfo: OfficialSelectedUserBasicInfoDataType
  cards?: Maybe<OfficialSelectedUserCardsType[]>
  dumpsters?: Maybe<OfficialSelectedUserDumpstersType[]>
  addressInfo?: Maybe<OfficialSelectedUserAddressInfoType[]>
  contracts?: Maybe<UserContractsType>
}

export interface OfficialFindSelectedUserDataQuery {
  __typename?: 'Query'
  official?: {
    ...
    user?: {
      ...
      get?: {
        ...
        result?: OfficialSelectedUserDataType | null
      } | null
    } | null
  } | null
}

export const OfficialSelectedUserGetDocument = {
  kind: 'Document',
  definitions: [
    {
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              ...
              name: {
                kind: 'Name',
                value: 'OfficialSelectedUserDataGetQueryProps',
              },
            },
          },
        },
                                    ...
                                    selectionSet: {
                                      ...
                                      selections: [
                                        ...
                                        },
                                        {
                                          ...
                                          name: {
                                            kind: 'Name',
                                            value: 'usersContract_communityID',
                                          },
                                        },
                                        {
                                          kind: 'Field',
  ...
  OfficialFindSelectedUserDataQuery,
  OfficialSelectedUserDataGetQueryProps
>
