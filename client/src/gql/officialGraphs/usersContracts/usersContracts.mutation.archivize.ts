...
export interface OfficialUserContractsArchivizeMutationProps {
...
export interface OfficialUserContractsArchivizeMutation {
  __typename?: 'Mutation'
  official?: {
...
export const OfficialUserContractsArchivizeDocument = {
  ...
  definitions: [
    {
      ...
      operation: 'mutation',
      name: { kind: 'Name', value: 'OfficialUserContractsArchivize' },
      variableDefinitions: [
        {
  ...
  OfficialUserContractsArchivizeMutation,
  OfficialUserContractsArchivizeMutationVariables
>
