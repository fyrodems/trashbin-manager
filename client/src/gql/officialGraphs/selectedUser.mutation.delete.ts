...
export interface OfficialDeleteUserMutationProps {
  user_ID: Scalars['Int']
}
...
export interface OfficialUsersDeleteMutation {
  __typename?: 'Mutation'
  official?: {
...
export const OfficialUsersDeleteDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'OfficialUsersDelete' },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              ...
              name: {
                kind: 'Name',
                value: 'OfficialDeleteUserMutationProps',
              },
            },
          },
        },
