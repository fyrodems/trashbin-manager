...
export interface CompanyCardsAddMutationProps {
  userID: Scalars['Int']
...
export interface CompanyCardsAddMutation {
  __typename?: 'Mutation'
  company?: {
...
export const CompanyCardsAddDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'CompanyCardsAdd' },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'CompanyCardsAddMutationProps' },
            },
          },
        },
      ],
  ...
  CompanyCardsAddMutation,
  CompanyCardsAddMutationVariables
>
