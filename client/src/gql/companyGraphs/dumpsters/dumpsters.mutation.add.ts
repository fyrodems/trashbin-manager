...
export interface CompanyDumpstersAddMutationProps {
  card_ID: Scalars['Int']
...
export interface CompanyDumpstersAddMutation {
  __typename?: 'Mutation'
  company?: {
...
export const CompanyDumpstersAddDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'CompanyDumpstersAdd' },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              ...
              name: {
                kind: 'Name',
                value: 'CompanyDumpstersAddMutationProps',
              },
            },
          },
        },
  ...
  CompanyDumpstersAddMutation,
  CompanyDumpstersAddMutationVariables
>
