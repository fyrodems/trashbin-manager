...
export interface CompanyAddressDeleteMutationProps {
...
export interface CompanyAddressDeleteMutation {
  __typename?: 'Mutation'
  company?: {
...
export const CompanyAddressDeleteDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'CompanyAddressDelete' },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              ...
              name: {
                kind: 'Name',
                value: 'CompanyAddressDeleteMutationProps',
              },
            },
          },
        },
