...
export interface AdminCardsOrdersVerifyAddMutationProps {
...
export interface AdminCardsOrdersVerifyAddMutation {
  __typename?: 'Mutation'
  admin?: {
...
export const AdminCardsOrdersVerifyAddDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'AdminCardsOrdersVerifyAdd' },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              ...
              name: {
                kind: 'Name',
                value: 'AdminCardsOrdersVerifyAddMutationProps',
              },
            },
          },
        },
  ...
  AdminCardsOrdersVerifyAddMutation,
