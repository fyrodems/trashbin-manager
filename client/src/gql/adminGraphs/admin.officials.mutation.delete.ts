...
export interface AdminOfficialsDeleteMutationProps {
  user_ID: Scalars['Int']
}
...
export interface AdminOfficialsDeleteMutation {
  __typename?: 'Mutation'
  admin?: {
...
export const AdminOfficialsDeleteDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'AdminOfficialsDelete' },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              ...
              name: {
                kind: 'Name',
                value: 'AdminOfficialsDeleteMutationProps',
              },
            },
          },
        },
  ...
  AdminOfficialsDeleteMutation,
  AdminOfficialsDeleteMutationVariables
>
