...
export interface AdminOwnersDeleteMutationProps {
  user_ID: Scalars['Int']
...
export interface AdminOwnersDeleteMutation {
  __typename?: 'Mutation'
  admin?: {
...
export const AdminOwnersDeleteDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'AdminOwnersDelete' },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              ...
              name: {
                kind: 'Name',
                value: 'AdminOwnersDeleteMutationProps',
              },
            },
          },
        },
  ...
  AdminOwnersDeleteMutation,
  AdminOwnersDeleteMutationVariables
>
