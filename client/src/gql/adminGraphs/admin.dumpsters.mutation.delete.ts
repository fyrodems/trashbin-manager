...
export interface AdminDumpstersDeleteMutationProps {
...
export interface AdminDumpstersDeleteMutation {
  __typename?: 'Mutation'
  admin?: {
...
export const AdminDumpstersDeleteDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'AdminDumpstersDelete' },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              ...
              name: {
                kind: 'Name',
                value: 'AdminDumpstersDeleteMutationProps',
              },
            },
          },
        },
  ...
  AdminDumpstersDeleteMutation,
  AdminDumpstersDeleteMutationVariables
>
