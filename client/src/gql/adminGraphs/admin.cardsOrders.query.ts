...
import { type AdminNewOrderType } from '../commonTypes'
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'cardsOrders' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      {
...
} as unknown as DocumentNode<AdminCardsOrdersQuery>
