...
export interface UserCardsDeleteMutationProps {
...
export interface UserCardsDeleteMutation {
  __typename?: 'Mutation'
  user?: {
...
export const UserCardsDeleteDocument = {
  ...
  definitions: [
    {
      ...
      operation: 'mutation',
      name: { kind: 'Name', value: 'UserCardsDelete' },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'UserCardsDeleteMutationProps' },
            },
          },
        },
      ],
  ...
  UserCardsDeleteMutation,
  UserCardsDeleteMutationVariables
>
