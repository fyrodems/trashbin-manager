...
export interface UserApplicationCancelMutationProps {
...
export interface UserApplicationCancelMutation {
  __typename?: 'Mutation'
  user?: {
    __typename?: 'UserMutation'
    applications?: {
      __typename?: 'OfficialApplicationCancelMutation'
      cancel?: {
...
export const UserApplicationCancelDocument = {
  ...
  definitions: [
    {
      ...
      operation: 'mutation',
      name: { kind: 'Name', value: 'UserApplicationCancel' },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              ...
              name: {
                kind: 'Name',
                value: 'UserApplicationCancelMutationProps',
              },
            },
          },
        },
  ...
  UserApplicationCancelMutation,
  UserApplicationCancelMutationVariables
>
