...
import { type CommonUserInfoType } from '../commonTypes'

export interface CommonUserGetQueryProps {
  props: {
...
export const CommonUserGetDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'CommonUserGet' },
      variableDefinitions: [
        {
...
} as unknown as DocumentNode<CommonUserQuery, CommonUserGetQueryProps>
