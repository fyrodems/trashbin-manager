...
import styles from './CompanyDumpsterCardBins.module.scss'
import { type DumpsterInfoType } from '@/gql/commonTypes'
import { WasteType } from '@/types/WasteType'

interface CompanyDumpsterCardBinsProps {
  dumpster: DumpsterInfoType
}

export const CompanyDumpsterCardBins: React.FC<
  CompanyDumpsterCardBinsProps
> = ({ dumpster }) => {
