...
export const OfficialDumpstersAddMutationProps = inputObjectType({
  name: 'OfficialDumpstersAddMutationProps',
  definition(t) {
...
export const OfficialDumpstersAddMutation = extendType({
  type: 'OfficialDumpstersMutation',
  definition(t) {
    t.field('add', {
      type: 'MutationResponseType',
      args: {
        props: nonNull('OfficialDumpstersAddMutationProps'),
      },
